...
},{"./post":5,"./ui":6,"./user":7,"xss-filters":1}],4:[function(require,module,exports){
"use strict";
...
function articleTemplate(title, lastReply) {
    var stitle = _xssFilters2.default.inHTMLData(title);
    var slastReply = _xssFilters2.default.inHTMLData(lastReply);
...
function userTemplate(name, avatar) {
    var sname = _xssFilters2.default.inHTMLData(name);
    var savatar = _xssFilters2.default.inHTMLData(avatar);
...
},{"./api":2,"./user":7,"xss-filters":1}],7:[function(require,module,exports){
"use strict";
